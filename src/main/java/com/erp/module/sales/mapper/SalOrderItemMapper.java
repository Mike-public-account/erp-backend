...
import com.erp.module.sales.dto.SalesPageDTO;
...
public interface SalOrderItemMapper extends BaseMapper<SalOrderItem> {
    ...
    /** 分页查询账期预警订单 */
    IPage<SalOrder> selectCreditWarningPage(IPage<SalOrder> page, @Param("dto") SalesPageDTO dto);

    /** 销售单分页列表 */
    IPage<SalOrder> selectSalesPage(IPage<SalOrder> page, @Param("dto") SalesPageDTO dto);
    /** 根据订单ID查询所有明细 */
